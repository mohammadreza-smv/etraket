  ...
  methods: {
    ...
    addFilterTag: function addFilterTag(param, key, value) {
      ...
      if (param === 'brand' && this.filterList['brands'] !== undefined) {
        for (var i = 0; i < this.filterList['brands'].length; i++) {
        ...
        for (var _i = 0; _i < this.filterList['colors'].length; _i++) {
          if (this.filterList['colors'][_i].id === parseInt(value)) {
            label1 = 'رنگ';

            if (this.filterList['colors'][_i].name !== null) {
              label2 = this.filterList['colors'][_i].name;
            }
          }
        }

        if (label1 !== null && label2 !== null) {
          var _event = 'addFilter("color","' + value + '","color_")';
        ...
        for (var _i2 = 0; _i2 < this.filterList['customItems'].length; _i2++) {
          var row = this.filterList['customItems'][_i2];
          ...
          if (row.param === param || row.param === param + '[' + key + ']') {
            ...
            if (label2 !== null) {
              var _event2 = 'addFilter("' + param + '","' + value + '","' + param + '_")';
        ...
        : _c(
            ...
            [
              ...
              _vm.selected_filter.length > 0
                ? _c(
                    ...
                    [
                      _c(
                        ...
                        [_c("span", [_vm._v("فیلتر های اعمال شده")])]
                      ),
                      _vm._v(" "),
                      _c(
                        "v-card-text",
                        ...
                        _vm._l(_vm.selected_filter, function(item, key) {
                          return _c(
                            "div",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.run_filter_event(item, key)
                                }
                              }
                            },
                            [
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.filterList["child_category"] !== undefined &&
              _vm.filterList["child_category"].length > 0
                ? _c(
                    "v-card",
                    { staticClass: "filter-box" },
                    [
                      _c(
                        "v-card-title",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.changeStatus("child_category")
                            }
                          }
                        },
                        [
                          ...
                          _c("v-spacer"),
                          _vm._v(" "),
                          _vm.boxStatus["child_category"] !== true
                      ...
                      _vm.boxStatus["child_category"] === true
                        ? _c("v-card-text", [
                            _c(
                              "div",
                              { staticClass: "child-cat-list-title" },
                              [
                                _c("v-icon", [_vm._v("mdi-chevron-down")]),
                                _vm._v(
                                  "\n                        " +
                                    _vm._s(_vm.filterList["category"]["name"]) +
                                    "\n                    "
                                )
                              ],
                              1
                            ...
                            _c(
                              "ul",
                              { staticClass: "child-cat-ul" },
                              _vm._l(_vm.filterList["child_category"], function(
                                cat
                              ) {
                                return _c("li", [
                                  _c(
                ...
                : _vm._e(),
              _vm._v(" "),
              _vm.filterList["brands"] !== undefined &&
              _vm.filterList["brands"].length > 0
                ? _c(
                    "v-card",
                    { staticClass: "filter-box" },
                    [
                      ...
                      _vm.boxStatus["brand"] === true
                        ? _c(
                            ...
                            [
                              _vm.filterList["brands"].length > 9
                                ? _c(
                                    "div",
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    "v-list-item-group",
                                    { attrs: { color: "primary" } },
                                    _vm._l(_vm.filterList["brands"], function(
                                      brand,
                                      key
                                    ) {
                                      return brand.get_brand !== null &&
                                        brand.get_brand.brand_name !== "" &&
                                        (_vm.searchText["brand"] ===
                                          undefined ||
                                          brand.get_brand.brand_name
                                            .toString()
                                            .indexOf(_vm.searchText["brand"]) >
                                            -1)
                                        ? _c(
                                            "v-list-item",
                                            { key: key, attrs: { dense: "" } },
                                                ...
                                                [
                                                  _c("v-checkbox", {
                                                    ...
                                                    model: {
                                                      ...
                                                      expression:
                                                        "checkbox['brand_'+brand.brand_id]"
                                                    }
                                                  })
                                                ],
                                                1
              ...
              _c(
                ...
                [
                  _c(
                    "v-card-text",
                    { staticStyle: { padding: "1px 10px 20px 10px" } },
                    [
                      _c("v-switch", {
                        attrs: {
              ...
              _vm._v(" "),
              _vm.filterList["colors"] !== undefined &&
              _vm.filterList["colors"].length > 0
                ? _c(
                    "v-card",
                    { staticClass: "filter-box" },
                    [
                      _c(
                        "v-card-title",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.changeStatus("color")
                            }
                          }
                        },
                        [
                          _c("span", [_vm._v("رنگ ها")]),
                          _vm._v(" "),
                          _c("v-spacer"),
                          _vm._v(" "),
                          _vm.boxStatus["color"] !== true
                            ? _c("v-icon", [_vm._v("mdi-chevron-down")])
                            : _c("v-icon", [_vm._v("mdi-chevron-up")])
                        ],
                        1
                      ...
                      _vm.boxStatus["color"] === true
                        ? _c(
                            ...
                            { staticStyle: { padding: "0px" } },
                            [
                              _vm.filterList["colors"].length > 9
                                ? _c(
                                    "div",
                                    { staticStyle: { margin: "10px" } },
                                    [
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    "v-list-item-group",
                                    { attrs: { color: "primary" } },
                                    _vm._l(_vm.filterList["colors"], function(
                                      color,
                                      key
                                    ) {
                                      return _vm.searchText["color"] ===
                                        undefined ||
                                        color.name
                                          .toString()
                                          .indexOf(_vm.searchText["color"]) > -1
                                        ? _c(
                                            "v-list-item",
                                            { key: key, attrs: { dense: "" } },
                                            [
                      ...
                      [
                        _c(
                          ...
                          [
                            ...
                            _c("v-spacer"),
                            _vm._v(" "),
                            _vm.boxStatus["attribute_" + row.param] !== true
                              ? _c("v-icon", [_vm._v("mdi-chevron-down")])
                              : _c("v-icon", [_vm._v("mdi-chevron-up")])
                          ],
                          1
                                ...
                                _c(
                                  ...
                                  [
                                    _c(
                                      "v-list-item-group",
                                      { attrs: { color: "primary" } },
                                      _vm._l(row.items, function(item, key2) {
                                        return _vm.searchText[
                                          row.param + "_" + row.param
                                        ] === undefined ||
                                          item.title
                                            .toString()
                                            .indexOf(
        ...
        _c("div", { staticClass: "product_list_box" }, [
          _c("div", { staticClass: "header" }, [
            _c("ul", { staticClass: "sort-ul" }, [
              _c("li", [
                _c("span", { staticClass: "fa fa-sort-amount-asc" }),
                ...
                _c("ul", [
                  ...
                  _c("li", [
                    _c(
                      "a",
                      {
                        attrs: { href: "https://wa.me?text=" + _vm.product_url }
                      },
                      [
                        _c("img", {
                          staticClass: "share-icon",
  ...
  return _c(
    ...
    [
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm.filterList["customItems"] !== undefined
                        ? _vm._l(_vm.filterList["customItems"], function(
                            row,
                            key
                          ) {
                            return _c(
                      ...
                      _vm._v(" "),
                      _vm.filterList["filter"] !== undefined
                        ? _vm._l(_vm.filterList["filter"], function(
                            filter,
                            key
                          ) {
                            return _c(
                                    ...
                                    _c(
                                      ...
                                      [
                                        _c(
                                          "v-list-item-group",
                                          { attrs: { color: "primary" } },
                                          _vm._l(filter["get_child"], function(
                                            child,
                                            key2
                                          ) {
                                            return _vm.searchText[
      ...
      _c(
        "v-navigation-drawer",
        {
          attrs: { width: "100%", bottom: "", app: "", height: "270" },
          model: {
