     ...
     <div>
         ...
         <div style="padding-bottom:20px">
             <div class="form-group">
                 ...
                 <select id="stockroom" v-model="stockroom_id" class="selectpicker auto_width">
...
export default({
    ...
    methods:{
        getProductWarrnty:function(page=1)
        {
            this.page=page;
            this.get_data=true;
            const url=this.$siteUrl+"/admin/stockroom/getProductWarrnty?page="+page+'&search_text='+this.search_text;
