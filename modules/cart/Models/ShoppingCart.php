...
class ShoppingCart
{
    ...
    public function __construct($cart_type=null,$defaultCartProduct=[])
    {
        $this->defaultCartProduct=$defaultCartProduct;
        $this->products($cart_type);
    }

    public function products($cart_type){
        $cartProducts=new CartProducts($cart_type);
        $cartProducts->cart=$this->defaultCartProduct;
