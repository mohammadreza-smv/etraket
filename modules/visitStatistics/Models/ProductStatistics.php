...
class ProductStatistics
{
    ...
    public function addUserVisit(){
        DB::table('statistics__user_visit_product')
            ->insert([
                'year'=>$this->year,
                'month'=>$this->month,
                'day'=>$this->day,
    ...
    public function addDayVisit($updateUnique){
        $row=DB::table('statistics__product_visit')
            ->where([
                'year'=>$this->year,
                'month'=>$this->month,
                'day'=>$this->day,
        ...
        if($row){
            ...
            DB::table('statistics__product_visit')
                ->where([
                    'year'=>$this->year,
                    'month'=>$this->month,
                    'day'=>$this->day,
    ...
    public function getVisit(){
        ...
        $visits=DB::table('statistics__product_visit')->where(['year'=>$year,'month'=>$month,'product_id'=>$this->product_id])
            ->get()->toArray();
        $unique_visit=array();
        $view=array();
        $google_visit=array();
