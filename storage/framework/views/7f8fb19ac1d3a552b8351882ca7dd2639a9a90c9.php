<?php $__env->startSection('content'); ?>
    ...
    <div>
        ...
        <payment-box
            price="<?php echo e(get_price($send_order_data['final_price'][1][$send_type])); ?>" token="<?php echo e(csrf_token()); ?>">
            ...
            <template v-slot:content>
                ...
                <?php if ($__env->exists('cart::checkout-products')) echo $__env->make('cart::checkout-products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('cart::layouts.order', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/teraketc/AppCode/modules/cart/resource/views/shipping/payment.blade.php ENDPATH**/ ?>