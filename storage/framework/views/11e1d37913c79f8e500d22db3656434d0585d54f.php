...
<div class="panel_content">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php if(array_search('status',$hide_fields)===false): ?>
        ...
        <div class="col-md-6">
            ...
            <div class="choice_pic_box" style="padding:20px">
                ...
                <?php if(isset($product)): ?>
                    <?php $url=url('files/products/'.$product->image_url) ?>
                <?php endif; ?>
...
<?php /**PATH /home2/teraketc/AppCode/modules/products/resource/views/_form.blade.php ENDPATH**/ ?>