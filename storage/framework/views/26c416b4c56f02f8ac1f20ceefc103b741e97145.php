            ...
            <div class="page faq_list" >
                ...
                <div  class="cat_info">
                    <?php if(!empty($cat->icon)): ?>
                        <img src="<?php echo e(url('files/upload/'.$cat->icon)); ?>" >
                    <?php endif; ?>
...
<?php echo $__env->make('front-theme::layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/teraketc/AppCode/modules/faq/resource/views/faq_category.blade.php ENDPATH**/ ?>