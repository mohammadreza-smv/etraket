                ...
                <?php if(isset($other)): ?>
                    <?php $__currentLoopData = $other; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <v-list-item>
                            ...
                            <v-list-item-title>
                                <a class="router-list" href="<?php echo e(url($route.'/create').$create_param); ?>">
...
<?php /**PATH /home2/teraketc/AppCode/modules/sellers/resource/views/panel/item_table.blade.php ENDPATH**/ ?>